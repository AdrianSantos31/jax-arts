  ...
  if($error){
    $empty = '<div class="alert alert-warning">
                ...
                if(!$error){
                  ...
                  $sqlinsert = "INSERT INTO details_final (dateUp, artName, apk, location, area, points, upBy, image_name, image) VALUES ('$date', '$artName', '$apk', '$location', '$area', '$points', '$upBy', '{$image_name}','{$image}')";
                  $_POST = array();
...
<html>
  ...
  <body>
    ...
    <!--Body-->
    <div class="container">
      <h1 id="mainQuestion"> Why should the arts in Jacksonville be funded?</h1>
      <?php
        echo $empty;
       ?>
      <?php
