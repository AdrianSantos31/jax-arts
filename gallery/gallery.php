    ...
    <div class="container">
      <div id="artDetails">
        <div class="row" id="result">
          <h1>Jacksonville Arts, Parks and Waterways<small> - Click picture for details</small></h1>
          <!-- <table class="table table-hover">
            ...
            <tbody id="answers"> -->
              ...
              //connect to DB
                include('../formAct.php');
                $query = "SELECT * FROM details_production ORDER BY id DESC";
                $result = mysqli_query($dbcon, $query);
                while($row = mysqli_fetch_array($result)){
                  // echo '<tr>';
                  // echo '<td>';

                  echo '<img class="clickPic" id="'.$row['id'] .'"onclick="showArtDetails(this.id)" src="../art/'.($row['image']).'"/>';
                  echo '&nbsp &nbsp';
